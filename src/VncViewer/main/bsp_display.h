...
#define CONFIG_BSP_LCD_WIDTH                    480
#define CONFIG_BSP_LCD_HEIGHT                   800
#define CONFIG_BSP_LCD_DPI_CLK                  34
#define CONFIG_BSP_LCD_HSYNC                    12
#define CONFIG_BSP_LCD_HBP                      42
#define CONFIG_BSP_LCD_HFP                      42
#define CONFIG_BSP_LCD_VSYNC                    2
#define CONFIG_BSP_LCD_VBP                      8
#define CONFIG_BSP_LCD_VFP                      166
#define CONFIG_BSP_LCD_RST_PIN                  5
#define CONFIG_BSP_LCD_BKLIGHT_PIN              23
#define CONFIG_BSP_MIPI_DSI_LANE_NUM            2
#define CONFIG_BSP_MIPI_DSI_LANE_RATE           1000
#define CONFIG_BSP_MIPI_PHY_LDO_CHAN            3
#define CONFIG_BSP_MIPI_PHY_LDO_MV              2500
#define CONFIG_BSP_TOUCH_I2C_SDA                7
#define CONFIG_BSP_TOUCH_I2C_SCL                8
#define CONFIG_BSP_TOUCH_I2C_SPEED              400000
#define CONFIG_BSP_TOUCH_RST                    22
#define CONFIG_BSP_TOUCH_INT                    21
...
void bsp_display_init(esp_lcd_panel_handle_t *ret_panel, esp_lcd_touch_handle_t *ret_touch);
